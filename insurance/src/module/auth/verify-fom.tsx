...
export function VerifyForm({
  ...
  async function onSubmit(event: React.SyntheticEvent) {
    ...
    try {
      ...
      const res = await fetch(`https://insurance-backend-3qao.onrender.com/api/v1/auth/verify-otp`, {
        method: "POST",
        headers: {
  ...
  async function resendOTpHandler() {
    ...
    try {
      ...
      const res = await fetch(`https://insurance-backend-3qao.onrender.com/api/v1/auth/resend-otp`, {
        method: "POST",
        headers: {
          "Content-type": "application/json",
          "x-api-key": apiKey,
